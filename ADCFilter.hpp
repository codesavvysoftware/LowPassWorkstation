...
namespace LowPassFilters
{
    ...
    public:
        ...
        /// @return none
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        void ApplyFilter(int32_t slADCValueRead, uint32_t ulCornerFreqToFilterHZ,  int32_t & rslFilterOutput, bool & rFilterAppliedSuccessfully);
        ...
        /// @param  ulSamplingPeriodUS     Sampling period for the filter in microseconds
        /// @param  rbFilterConfigured     true when the filter was configured, false when the corner frequency is not 
        ///                                100HZ, 50 HZ, 25HZ 10HZ, 5HZ or 1HZ.
        ///
        /// @return  none
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
